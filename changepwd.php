...
if (count($_POST) > 0) {
    $result = mysqli_query($con, "SELECT *from student WHERE student_id='".$_SESSION["student_id"]."'");
    $row = mysqli_fetch_array($result);
    if ($_POST["currentPassword"] == $row["student_password"]) {
        mysqli_query($con, "UPDATE student set student_password='".$_POST["newPassword"]."' WHERE student_id='".$_SESSION["student_id"]."'"); 
