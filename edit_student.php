...
if(isset($_POST['btn_submit']) && $_GET['edit']!=''){  
    extract($_POST);  
     ...
     student_batch='$student_batch',student_address='$student_address',student_tenth='$student_tenth',student_inter='$student_inter', 
     student_grad='$student_grad',student_1_1='$student_1_1',student_1_2='$student_1_2',student_2_1='$student_2_1',student_2_2='$student_2_2',
    student_3_1='$student_3_1',student_3_2='$student_3_2',student_4_1='$student_4_1',student_4_2='$student_4_2' $sql where `student_id`='".$_GET['edit']."'"); 	   
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6 col-sm-6">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" disabled class="form-control" name="student_idno" value="<?=$rw['student_idno']?>" placeholder="Student ID number" id="username" onBlur="checkAvailability()" required>
                                <div class="input-group-append">
                                    <div class="input-group-text">
                                        <span class="fas fa-user"></span>
                                    </div>
                            ...
                            <div class="input-group mb-3">
                            <select class="form-control" name="student_batch " required>
                                    <option>Select Batch</option>
                                    <?  
                                        $rrr=mysqli_query($con,"SELECT * FROM `batch` ORDER BY batch_id ASC"); 
                                        while($r1=mysqli_fetch_assoc($rrr)){ ?>
                                            <option value="<?=$r1['batch_name']?>" <? if($rw['student_batch'] == $r1['batch_name']) echo "selected";?>><?=$r1['batch_name']?></option>
                                    <? }  
                                    ?>
                                </select>  
                                <div class="input-group-append">
                        ...
                        <div class="col-md-6 col-lg-6 col-sm-6"> 
                            ...
                            <div class="input-group mb-3">
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="student_1_1" value="<?=$rw['student_1_1']?>" placeholder="1st Year Sem 1" >
                                    </div>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="student_1_2" value="<?=$rw['student_1_2']?>" placeholder="1st Year Sem 2" >
                                    </div> 
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="student_2_1"  value="<?=$rw['student_2_1']?>" placeholder="2nd Year Sem 1" >
                                    </div>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="student_2_2" value="<?=$rw['student_2_2']?>" placeholder="2nd Year Sem 2" >
                                    </div>
                                </div>
                            </div>
                            <div class="input-group mb-3">
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="student_3_1" value="<?=$rw['student_3_1']?>" placeholder="3rd Year Sem 1" >
                                    </div>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="student_3_2" value="<?=$rw['student_3_2']?>" placeholder="3rd Year Sem 2" >
                                    </div> 
                                </div>
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="student_4_1" value="<?=$rw['student_4_1']?>" placeholder="4th Year Sem 1" >
                                    </div>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="student_4_2" value="<?=$rw['student_4_2']?>" placeholder="4th Year Sem 2" >
                                    </div>
                                </div> 
                            </div>
                        </div>  
