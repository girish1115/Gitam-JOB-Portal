    ...
    <section class="content">
      ...
      <div class="row">
        ...
        while($row11=mysqli_fetch_assoc($tt2)){ ?>
           <div class="list-group">
           <!--<div class="list-group-item list-group-item-action list-group-item-info"><label ><b>Company Name: </b><?//=$row11['hr_fullname '];?></label></div>
            <div class="list-group-item list-group-item-action"><label ><b>HR Email: </b><?//=$row11['hr_email'];?></label> </div>

            <div class="list-group-item list-group-item-action list-group-item-info"><label ><b>HR Number: </b><?//=$row11['he_number'];?></label></div>-->
